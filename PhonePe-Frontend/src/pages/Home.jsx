...
function Home() {
    ...
    useEffect(() => {
        const fetchMerchantDetails = async () => {
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/accounts/details-by-phone?phoneNumber=${phoneNumber}`);
                if (!response.ok) {
                ...
                console.log("Received merchant data:", data);
    ...
    return (
        <div className="bg-[#581389] container mx-auto p-4 space-y-6">
            ...
            <div className="bg-wheat p-6 rounded-xl shadow-lg">
